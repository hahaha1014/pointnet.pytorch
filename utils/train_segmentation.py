...
# parser.add_argument('--model', type=str, default='seg/seg_model_Scene_15.pth', help='model path')
...
print('feature_transform', opt.feature_transform)
try:
...
if opt.model != '':
    ...
    print("load pre-trained model seccuss!!!")
...
for i,data in tqdm(enumerate(testdataloader, 0)):
    ...
    correct = np.sum(pred_np == target_np)
    total = pred_np.size
    acc = correct / total
    all_acc.append(acc)
